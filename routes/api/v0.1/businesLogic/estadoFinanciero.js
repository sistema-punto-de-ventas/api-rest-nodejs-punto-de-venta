...
class EstadoFinanciero {
    ...
    // obtiene le capital de inversion, ganacias y el monto total= inversion + ganacias
    static async getCapitaGancias(req, res, next){
...
// total inversion = cantdad * precio
 async function getTotalInversion(LisProducts){
